...
export default function SignupPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      trackViewContent(`${window.location.origin}/signup`);
    }
  }, []);
        ...
        <div className="max-w-[1320px] w-full px-5 mx-auto">
          <div className="max-w-[420px] w-full text-center mx-auto">
            ...
            <div className="space-y-4">
              ...
              />
              <p className="text-sm font-normal leading-[120%] text-white/60">Already have an account? <Link href="/login" className="text-white underline">Log In</Link></p>
