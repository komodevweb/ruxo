      ...
      <body className="antialiased bg-black-1100 font-inter" suppressHydrationWarning>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1891419421775375&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* End Meta Pixel Code */}
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              snaptr('init', '5bf81ee1-15b1-4dc1-b636-d7dae49b950e', {});
