                         ...
                         {loadingJobs || !hasLoadedOnce || authLoading ? (
                              ...
                              <div className="w-full max-w-[1320px] mx-auto">
                                   <div className="md:hidden block mb-6 px-5" style={{ paddingBottom: 'max(1.5rem, calc(1.5rem + env(safe-area-inset-bottom, 0px)))' }}>
                                        <div className="text-center mb-6">
                                             ...
                                             <h2 className="text-[38px] font-medium text-white leading-[120%] my-4 tracking-[-1px]">Words Become Cinema</h2>
                                             <p className="text-sm font-medium leading-[120%] text-white/60 mb-6">Access Sora, Veo 3, Kling, Minimax & more. All the world's best AI video models in one place.</p>
                                             <button 
                              ...
                              <>
                                   <div className="text-center mb-6 pt-4 md:pt-0">
                                        ...
                                        <h2 className="md:text-5xl text-[38px] font-medium text-white leading-[120%] my-4 tracking-[-1px]">Words Become Cinema</h2>
                                        <p className="md:text-base text-sm font-medium leading-[120%] text-white/60">Access Sora, Veo 3, Kling, Minimax & more. All the world's best AI video models in one place.</p>
