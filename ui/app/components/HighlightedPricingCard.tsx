// components/HighlightedPricingCard.tsx
...
interface HighlightedPricingCardProps {
     plan: string;
     price: string;
...
const HighlightedPricingCard: React.FC<HighlightedPricingCardProps> = ({
     ...
     return (
          <div className="w-full relative p-[1px] rounded-4xl">

               <div className="bg-[url(/images/bg-dots.png)] rounded-4xl absolute inset-0"></div>


               <div className="absolute inset-0 rounded-4xl top-0 left-0 bg-linear-to-b from-blue5/60 to-blue2"></div>


               <div className="relative z-10 w-full rounded-4xl p-8 h-full pricing-most-card">

                    <h5 className="text-lg font-inter font-medium text-white/60 mb-6">
                         {plan}
                    </h5>
                    ...
                    <div className="flex items-end gap-2 mb-3">
                         <div className="flex flex-col">
                              ...
                              <div className="flex items-end gap-2">
                                   ...
                                   <h4 className="text-sm font-inter font-medium text-white">
                                        {duration}
                                   </h4>
                              </div>
                         </div>
                    ...
                    <p className="text-base font-medium text-white/60 tracking-tighter mb-8">
                         {description}
                    </p>
